...
public class ConectorDBTest {
    ...
    public void testBuscarPrioridades() {
        ...
        result.forEach(prioridad -> {
            expResult.forEach(p -> {
                if (prioridad.getId() == p.getId() && prioridad.getNombre().equals(p.getNombre())) {
                    assertTrue(true);
                }
            });
        });
     ...
     */
    @Test
    public void testBuscarUsuariosEnGrupoNoAdminGrupoNoExiste() {
        System.out.println("BuscarUsuariosEnGrupoNoAdmin");
        /**
         * El servidor devuelve true si encuentra algun usuario del grupo 1 con
         * el valor "admin" en false, y false si no encuentra a ninguno.
    ...
    public void testBuscarLugaresParaUnGrupo() {
        ...
        /**
         * El grupo 1 tiene asignado actualmente en la base de datos 2 lugares.
         * debe devolver true.
         */
        int grupoid = 1;
        boolean expResult = true;
     ...
     */
    @Test
    public void testBuscarLugaresParaUnGrupoSinLugar() {
        System.out.println("BuscarLugaresParaUnGrupo");
        /**
         * El grupo 0 no tiene asignado actualmente lugares. debe devolver
         * false.
         */
        int grupoid = 0;
        boolean expResult = false;
    ...
    public void testBuscarGrupos() {
        ...
        /**
         * Actualmente hay dos grupos en la base de datos. si el tamaño de la
         * lista es igual a 2 se considera el test superado.
         */
        int expResult = 2;
    ...
    public void testBuscarLugares() {
        ...
        /**
         * Actualmente hay 5 lugares en la base de datos. si el tamaño de la
         * lista obtenida es igual a 5, el test se considera superado.
         */
        int expResult = 5;
        LinkedList<Lugar> result = ConectorDB.BuscarLugares();
        if (expResult == result.size()) {
            assertTrue(true);
        }
    }
    ...
    public void testBuscarTareas() {
        ...
        /**
         * para el dia actual y el grupo 1 solo existe una tarea en la base de
         * datos. si el tamaño de la lista es igual a 1 se considera el test
         * superado.
         */
        DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String strDate = dateFormat.format(Date.valueOf(LocalDate.now()));
        int idgrupo = 1;
        int expResult = 1;
        LinkedList<Tarea> result = ConectorDB.BuscarTareas(strDate, idgrupo);
        if (expResult == result.size()) {
            assertTrue(true);
        }
    }
    ...
    public void testBuscarTareaPorId() {
        ...
        /**
         * vamos a buscar la tarea con id 5 y comprobar que la que obtenemos
         * tiene el mismo nombre y color.
         */
        Tarea tarea = new Tarea(5, null, null, null, 0, 0, true, 0, null, null, null, null);
        Tarea expResult = new Tarea(5, "pediatria", "#D633FF", null, 0, 0, true, 0, new LinkedList<Persona>(), null, null, "admin");
        Tarea result = ConectorDB.BuscarTareaPorId(tarea);
        if ((expResult.getNombre().equals(result.getNombre())) && expResult.getColor().equals(result.getColor())) {
            assertTrue(true);
        }
    }
    ...
    public void testCrearEmpleado() {
        ...
        boolean expResult = true;
        boolean result = ConectorDB.CrearEmpleado(persona);
        assertEquals(expResult, result);
    }
